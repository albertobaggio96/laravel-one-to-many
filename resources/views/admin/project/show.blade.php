...
@section('content')
    <section class="container text-center my-5">
      ...
      <div class="d-flex mt-2">
        <a href="{{ route("admin.project.show", $prevProject->slug ?? "") }}" class="@if(!isset($prevProject)) disabled @endisset me-auto btn-prev">Prev</a>

        <a href="{{ route("admin.project.index") }}" class="py-2 px-4 btn-arrow bg-black"><i class="fa-solid fa-pen-to-square"></i></a>
        ...
        <a href="{{ route("admin.project.show", $nextProject->slug ?? "") }}" class="@if(!isset($nextProject)) disabled @endisset  btn-next ms-auto">Next</a>
      </div>
    </section>
@endsection
